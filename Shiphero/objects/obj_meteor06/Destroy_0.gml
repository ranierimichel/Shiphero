...
if(room == rm_game){
	...
	if(instance_exists(obj_planet)){
		if(obj_planet.parts){
			var _pts = image_alpha < 1 ? (points.meteor06*2)*2 : points.meteor06*2;		
			global.point += _pts;
		} else {
			var _pts = image_alpha < 1 ? (points.meteor06*2) : points.meteor06;
			global.point += _pts;	
		}
	} 
