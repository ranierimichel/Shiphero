...
if(room == rm_game){
	...
	if(instance_exists(obj_planet)){
		if(obj_planet.parts){
			var _pts = image_alpha < 1 ? (points.meteor08*2)*2 : points.meteor08*2;		
			global.point += _pts;
		} else {
			var _pts = image_alpha < 1 ? (points.meteor08*2) : points.meteor08;
			global.point += _pts;	
		}
	} 
	...
	var _choose = irandom_range(0,20);

	switch(_choose){
	    case 0:
			var _m = instance_create_layer(x,y,"Meteors07",obj_meteor01);
			var _m1 = instance_create_layer(x,y,"Meteors01",obj_meteor01);
			_m.image_index = image_index;
			_m1.image_index = image_index;
	    break;
	    case 1:
			var _m = instance_create_layer(x,y,"Meteors06",obj_meteor01);
	    ...
	    break;
	    case 3:
			var _m = instance_create_layer(x,y,"Meteors05",obj_meteor01);
			var _m1 = instance_create_layer(x,y,"Meteors03",obj_meteor01);
			_m.image_index = image_index;
			_m1.image_index = image_index;
	    break;
	    case 4:
			var _m = instance_create_layer(x,y,"Meteors05",obj_meteor01);
			var _m1 = instance_create_layer(x,y,"Meteors02",obj_meteor01);
			var _m2 = instance_create_layer(x,y,"Meteors01",obj_meteor01);
			_m.image_index = image_index;
			_m1.image_index = image_index;
			_m2.image_index = image_index;
	    break;
	    case 5:
			var _m = instance_create_layer(x,y,"Meteors05",obj_meteor01);
			_m.image_index = image_index;
	    ...
	    case 13:
			...
			_m1.image_index = image_index;
	         repeat (2) {
				var _m2 = instance_create_layer(x,y,"Meteors02",obj_meteor01);
				_m2.image_index = image_index;
			}
	    break;
	    case 14:
