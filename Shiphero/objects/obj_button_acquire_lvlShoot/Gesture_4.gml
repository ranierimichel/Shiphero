...
global.lvl_shoot += buttonPUPoints.lvlshoot;

//global.gem -= buttonPUCost.lvlshoot;
// efeito
if(instance_exists(obj_ship_father)){
	...
	part_type_color1(global.particle_pu,c_yellow);
...
//show_text.text = buttonPUPoints.lvlshoot;
...
//	var show_text = instance_create_layer(_xx,_yy,"Instances",obj_show_text);
//	show_text.text = buttonPUCost.lvlshoot;
//	show_text.critical = true; // critical quer dizer mostrar maior
//	show_text.color = c_yellow;
//}
