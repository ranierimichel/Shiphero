...
global.dexterity += buttonPUPoints.dexterity;

//global.gem -= buttonPUCost.dexterity;
// efeito
if(instance_exists(obj_ship_father)){
	...
	part_type_color1(global.particle_pu,c_blue);
...
//show_text.text = buttonPUPoints.dexterity;
...
//	var show_text = instance_create_layer(_xx,_yy,"Instances",obj_show_text);
//	show_text.text = buttonPUCost.dexterity;
//	show_text.critical = true; // critical quer dizer mostrar maior
